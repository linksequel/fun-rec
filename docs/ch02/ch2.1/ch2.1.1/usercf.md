...
<div align=center>
<img src="../../../imgs/ch02/ch2.1/ch2.1.1/usercf/image-20210629232540289.png" alt="image-20210629232540289" style="zoom: 90%;" />
</div>
...
<div align=center>
<img src="../../../imgs/ch02/ch2.1/ch2.1.1/usercf/image-20210629232622758.png" alt="image-20210629232622758" style="zoom: 80%;" />
</div>
...
1. 计算 Alice 与其他用户的相似度（基于皮尔逊相关系数）
   ...
   + 计算所有用户之间的皮尔逊相关系数。可以看出，与 Alice 相似度最高的用户为用户1和用户2。

     <img src="../../../imgs/ch02/ch2.1/ch2.1.1/usercf/JavaWJkjP2fHH27Rajrj.png" alt="图片" style="zoom:80%;" />    
